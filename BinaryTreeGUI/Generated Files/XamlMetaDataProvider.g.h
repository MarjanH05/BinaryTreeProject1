...
namespace winrt::BinaryTreeGUI::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, BinaryTreeGUI::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = BinaryTreeGUI::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"BinaryTreeGUI.XamlMetaDataProvider";
        }
    };
}
namespace winrt::BinaryTreeGUI::factory_implementation
{
    ...
    {
        using instance_type = BinaryTreeGUI::XamlMetaDataProvider;
