...
namespace winrt::BinaryTreeGUI::implementation
{
    ...
    void MainWindowT<D, I...>::Connect(int32_t connectionId, IInspectable const& target)
    {
        ...
        case 2:
            {
                ...
                this->ProcessButton(targetElement);
                ...
                targetElement.Click([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Microsoft::UI::Xaml::RoutedEventArgs const& p1){
                    ...
                    {
                        ::winrt::get_self<D>(t)->ProcessButton_Click(p0, p1);
                    }
                });
            }
            break;
        ...
        case 6:
            {
                ...
                targetElement.Click([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Microsoft::UI::Xaml::RoutedEventArgs const& p1){
                    if (auto t = weakThis.get())
                    {
                        ::winrt::get_self<D>(t)->SelectExistingOutput_Click(p0, p1);
                    }
                });
            }
            break;
        case 7:
            {
                ...
                targetElement.Click([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Microsoft::UI::Xaml::RoutedEventArgs const& p1){
                    if (auto t = weakThis.get())
                    {
                        ::winrt::get_self<D>(t)->PlaceNewOutput_Click(p0, p1);
                    }
                });
            }
            break;
        case 8:
            {
                auto targetElement = target.as<::winrt::Microsoft::UI::Xaml::Controls::TextBox>();
                this->InputFileTextBox(targetElement);
            }
            break;
        case 9:
            {
                ...
                targetElement.Click([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Microsoft::UI::Xaml::RoutedEventArgs const& p1){
                    if (auto t = weakThis.get())
                    {
                        ::winrt::get_self<D>(t)->SelectInputFile_Click(p0, p1);
                    }
                });
            }
            break;
