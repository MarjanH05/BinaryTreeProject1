...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"BinaryTreeGUI.MainWindow"))
    {
        return winrt_make_BinaryTreeGUI_MainWindow();
    }

    if (requal(name, L"BinaryTreeGUI.XamlMetaDataProvider"))
    {
        return winrt_make_BinaryTreeGUI_XamlMetaDataProvider();
    }
