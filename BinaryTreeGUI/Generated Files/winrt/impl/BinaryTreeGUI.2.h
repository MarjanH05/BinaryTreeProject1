...
#pragma once
#ifndef WINRT_BinaryTreeGUI_2_H
#define WINRT_BinaryTreeGUI_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/BinaryTreeGUI.1.h"
WINRT_EXPORT namespace winrt::BinaryTreeGUI
{
    struct WINRT_IMPL_EMPTY_BASES MainWindow : winrt::BinaryTreeGUI::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow, winrt::Microsoft::UI::Xaml::IWindow2>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::BinaryTreeGUI::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
